...
export const CardSidebar = ({ board, card, updateField, onOpenPopover, dueDate }) => {
    return (
        <aside className="card-sidebar">
            ...
            <button
                name="add-labels"
                onClick={ev => onOpenPopover(ev, { board, card, updateField })}>
                <LabelIcon/>
                Labels
            </button>
            <button
                name="add-checklist"
                onClick={ev => onOpenPopover(ev, { card, updateField })}>
                <CheckBoxIcon />
                Checklist
            </button>
            <button
                name="add-due-date"
                onClick={ev => onOpenPopover(ev, { dueDate, updateField })}>
                <DateIcon />
                Date
            </button>
            <button>
            ...
            <button
                name="add-location"
                onClick={ev =>
                    onOpenPopover(ev, { card, updateField, currPage: 'save', isFromNav: true })
                }>
                <LocationIcon />
                Location
            </button>
