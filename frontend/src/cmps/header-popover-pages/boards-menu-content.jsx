...
function _BoardsMenuContent({ boards, board, user, history, onClose }) {
    ...
    const hasStarredBoards = boards.some((board) =>
    ...
    return (
        <>
            {board && <div className='current-board list-group'>
            ...
            {hasBoards && <div className='your-boards list-group'>
                <div>YOUR BOARDS</div>
                <ul>
                    {boards
            ...
            {hasStarredBoards && <div className='guest-boards your-boards list-group'>
